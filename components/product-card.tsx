...
export function ProductCard({
  ...
  const discountAmount = regular_price - event_price
  ...
  return (
    <Link href={`/product/${id}`} className="block group">
      <div
        className="relative bg-white rounded-lg duration-300 overflow-hidden border-[0.5px] hover:border-2"
      ...
      >
        ...
        <div className="p-2">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <span className="text-green-600 font-bold text-sm">₹{event_price.toLocaleString()}</span>
            <span className="text-gray-400 line-through text-sm">₹{regular_price.toLocaleString()}</span>
